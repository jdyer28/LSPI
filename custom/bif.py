...
class EntityDataGenerator(BasePreload):
    ...
    start_entity_id = 1000  # used to build entity ids
    auto_entity_count = 0  # default number of entities to generate data for
    data_item_mean = None
    data_item_sd = None
    ...
    #     '''
    #     ids = ['LP-' + str(1000 + x) for x in list(range(5))]
    #     return (ids)
